h1. Fork is created to fix a problem with multiple --extern parameters passed to compiler.

On 25th of may 2011 it was pulled to original project to master. 
*It is advised to use documentcloud/closure-compiler version.*
